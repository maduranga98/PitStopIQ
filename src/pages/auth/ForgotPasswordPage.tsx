      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-[#162032] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
          <div className="px-8 pt-8 pb-2">
            ...
            <p className="text-sm text-gray-400 mt-1">Contact us to reset your password</p>
          </div>
          <div className="px-8 pb-8 pt-4">
            <div className="bg-[#0B1120] border border-white/10 rounded-xl p-5 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-white mb-1">Contact your PitstopIQ administrator</p>
                  <p className="text-sm text-gray-400">
                    Password resets are handled by the PitstopIQ admin team. Contact us via WhatsApp or SMS and we will reset your password and send you a new one.
                  </p>
                </div>
              </div>
            </div>
