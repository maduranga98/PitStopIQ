...
export default function NewQuotationPage() {
  ...
  async function handleCreate() {
    ...
    try {
      ...
      let seq = 1;
      if (!lastSnap.empty) {
        const lastNum = lastSnap.docs[0].data().quotationNumber as string;
      ...
      const quoRef = await safeAddDoc(collection(db, "servicecenters", centerId, "quotations"), {
        quotationNumber,
    ...
    <div className="min-h-screen bg-[#0B1120]">
      ...
      <div className="border-b border-white/10 bg-[#0B1120]/80 backdrop-blur sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            <div className="text-xs text-gray-500 uppercase tracking-wider">Quotations</div>
            <div className="text-lg font-bold text-white">New Quotation</div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-5">
        ...
        {/* Validity + notes */}
        <div className="bg-[#162032] border border-white/10 rounded-xl p-4 space-y-3">
          <div className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Validity & Notes</div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full bg-white/5 border border-white/10 text-white rounded-lg px-3 py-2 text-sm placeholder-gray-500 focus:outline-none focus:border-orange-500 resize-none"
          />
        </div>
