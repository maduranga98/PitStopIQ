...
export const DEFAULT_PERMISSIONS: Record<StaffRoleKey, RolePermissions> = {
  manager: {
    ...
    staff: { view: true, manage: true, viewAuditLog: true },
  ...
  technician: {
    ...
    staff: { view: false, manage: false, viewAuditLog: false },
  ...
  cashier: {
    ...
    inventory: { view: true, create: false, edit: false, restock: false, viewLogs: true, delete: false, request: false, approveRequests: false, manageCategories: false, stockCount: false },
    // A cashier rings up outlet sales; they can see which outlets exist but
    // don't manage them.
    outlets: { view: true, create: false, edit: false, delete: false },
...
export const LOCKED_OFF: Record<StaffRoleKey, ReadonlySet<string>> = {
  ...
  technician: new Set([
    ...
    "invoices.delete",
    "quotations.view",
    "quotations.viewDetail",
    "quotations.create",
    "quotations.edit",
    "quotations.downloadPdf",
    "quotations.shareWhatsapp",
    "quotations.delete",
    "inventory.create",
    "inventory.edit",
    "inventory.restock",
    ...
    // Outlets/POS are a retail counter, separate from the workshop floor.
    "outlets.view",
    "outlets.create",
    "outlets.edit",
    "outlets.delete",
