...
define(['./workbox-709a0e9a'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "/index.html",
    "revision": "0.n271p2abnd"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/index.html"), {
    allowlist: [/^\/$/],
    denylist: [/^\/assets\//, /\.[a-z0-9]+$/i]
  }));
  ...
  workbox.registerRoute(/^https:\/\/.*\.googleapis\.com\/(?!fonts).*/i, new workbox.NetworkOnly(), 'GET');
  workbox.registerRoute(/^https:\/\/.*\.cloudfunctions\.net\/.*/i, new workbox.NetworkOnly(), 'GET');
